...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.files}}", "update,files.update,temp.path,cache.images,m3uWithoutPorts,xepg.replace.missing.images,xepg.replace.channel.title,enableNonAscii"))
